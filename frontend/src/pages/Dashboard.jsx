  ...
  return (
    <div className="p-4 md:p-6 space-y-5 main-content">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          { label: 'Scanner', value: status.toUpperCase(), icon: Activity, color: isRunning ? '#10b981' : isPaused ? '#f59e0b' : '#6b7280', bg: isRunning ? 'rgba(16,185,129,0.1)' : 'rgba(107,114,128,0.1)' },
          { label: 'Scanned', value: stats.scanned, icon: BarChart2, color: '#6366f1', bg: 'rgba(99,102,241,0.1)' },
          { label: 'Signals', value: stats.matched, icon: TrendingUp, color: '#8b5cf6', bg: 'rgba(139,92,246,0.1)' },
